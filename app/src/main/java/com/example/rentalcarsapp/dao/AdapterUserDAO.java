...
public class AdapterUserDAO extends FirebaseRecyclerAdapter<User,AdapterUserDAO.myviewholder> {
    public AdapterUserDAO(@NonNull FirebaseRecyclerOptions<User> options)
    {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull final myviewholder holder, final int position, @NonNull final User model)
    {
        ...
        holder.phone.setText(model.getUserPhoneNumber());
        holder.email.setText(model.getUserEmail());
        Glide.with(holder.img.getContext()).load(model.getUserImages()).into(holder.img);
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                purl.setText(model.getUserImages());
                name.setText(model.getFullName());
                phone.setText(model.getUserPhoneNumber());
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        map.put("course",phone.getText().toString());
    ...
    class myviewholder extends RecyclerView.ViewHolder
    {
        ...
        public myviewholder(@NonNull View itemView)
        {
            ...
            phone=(TextView)itemView.findViewById(R.id.coursetext);
